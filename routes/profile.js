...
const { uploadProfilePic, handleMulterError } = require('../middleware/upload');
...
router.post('/edit', isAuthenticated, uploadProfilePic, handleMulterError, profileController.updateProfile);
